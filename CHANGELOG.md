...
deviations, 583 accepted deviations and 615 register keys. The run also reports 172 unaccepted
...
32 add up to the 615 register keys. A count that an entry below states therefore differs from
a fresh run.
