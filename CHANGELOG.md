...
issue #249 put 1 more, and issue #449 put 4 more.
...
the current tree
reports 1754 matches, 260
deviations, 592 accepted deviations and 624 register keys. The run also reports 175 unaccepted
uncovered values and 32 accepted uncovered values, and #361 states what an uncovered value is.
An accepted deviation and an accepted uncovered value each name one register entry, so 592 and
32 add up to the 624 register keys. A count that an entry below states therefore differs from
a fresh run.
