...
issue #503 put 1 more, issue #126 put 6 more, issue #528 put 3 more, and issue #229 put 2
more.
...
the current tree
reports 1754 matches, 265
deviations, 587 accepted deviations and 619 register keys. The run also reports 175 unaccepted
uncovered values and 32 accepted uncovered values, and #361 states what an uncovered value is.
An accepted deviation and an accepted uncovered value each name one register entry, so 587 and
32 add up to the 619 register keys. A count that an entry below states therefore differs from
a fresh run.
