...
|---|---|---|---|
| per-stream | 703 | 514 | 150 |
| per-packet | 332 | 834 | 0 |

An accepted deviation is an entry of `testdata/deviations.json`, which records a ruling.

## Deviations

The run reports 1498 deviations in 175 groups. One group is one capture, one method and one vector set.
...
| `gre-sample.pcap` | per-packet | JA4SSH | 2 | `gre-sample.pcap/30/JA4SSH.1` | the vector holds a value the library does not produce | `c24s23_c4s4_c5s4` | (none) |
| `gre-sample.pcap` | per-packet | JA4SSH | 2 | `gre-sample.pcap/31/JA4SSH.1` | the vector holds a value the library does not produce | `c24s23_c4s4_c5s4` | (none) |
...
| `ssh-r.pcap` | per-packet | JA4SSH | 11 | `ssh-r.pcap/1011/JA4SSH.1` | the vector holds a value the library does not produce | `c76s76_c108s92_c0s105` | (none) |
| `ssh-r.pcap` | per-packet | JA4SSH | 11 | `ssh-r.pcap/1318/JA4SSH.1` | the vector holds a value the library does not produce | `c76s76_c106s94_c0s107` | (none) |
| `ssh-r.pcap` | per-packet | JA4SSH | 11 | `ssh-r.pcap/1620/JA4SSH.1` | the vector holds a value the library does not produce | `c76s76_c111s89_c0s102` | (none) |
...
| `ssh-r.pcap` | per-stream | JA4SSH | 8 | `ssh-r.pcap/0/JA4SSH.1` | the two values differ | `c64s64_c107s93_c74s10` | `c28s21_c4s3_c115s12` |
| `ssh-r.pcap` | per-stream | JA4SSH | 8 | `ssh-r.pcap/0/JA4SSH.2` | the vector holds a value the library does not produce | `c64s64_c0s0_c0s1` | (none) |
| `ssh-r.pcap` | per-stream | JA4SSH | 8 | `ssh-r.pcap/1/JA4SSH.1` | the two values differ | `c64s64_c6s5_c4s5` | `c16s21_c4s3_c4s5` |
...
| `ssh-scp-1050.pcap` | per-packet | JA4SSH | 4 | `ssh-scp-1050.pcap/247/JA4SSH.1` | the vector holds a value the library does not produce | `c112s1460_c52s148_c41s4` | (none) |
| `ssh-scp-1050.pcap` | per-packet | JA4SSH | 4 | `ssh-scp-1050.pcap/482/JA4SSH.1` | the vector holds a value the library does not produce | `c112s1460_c13s187_c35s0` | (none) |
| `ssh-scp-1050.pcap` | per-packet | JA4SSH | 4 | `ssh-scp-1050.pcap/718/JA4SSH.1` | the vector holds a value the library does not produce | `c0s1460_c0s200_c36s0` | (none) |
| `ssh-scp-1050.pcap` | per-stream | JA4L | 1 | `ssh-scp-1050.pcap/0/JA4L-C` | the two values differ | `6615_128` | `179_128` |
| `ssh-scp-1050.pcap` | per-stream | JA4SSH | 4 | `ssh-scp-1050.pcap/0/JA4SSH.1` | the two values differ | `c112s1460_c52s148_c41s4` | `c32s21_c4s3_c140s4` |
| `ssh-scp-1050.pcap` | per-stream | JA4SSH | 4 | `ssh-scp-1050.pcap/0/JA4SSH.2` | the vector holds a value the library does not produce | `c112s1460_c13s187_c35s0` | (none) |
| `ssh-scp-1050.pcap` | per-stream | JA4SSH | 4 | `ssh-scp-1050.pcap/0/JA4SSH.3` | the vector holds a value the library does not produce | `c112s1460_c0s200_c36s0` | (none) |
| `ssh.pcapng` | per-packet | JA4SSH | 1 | `ssh.pcapng/200/JA4SSH.1` | the vector holds a value the library does not produce | `c36s36_c76s124_c0s0` | (none) |
| `ssh.pcapng` | per-stream | JA4SSH | 1 | `ssh.pcapng/0/JA4SSH.1` | the two values differ | `c36s36_c76s124_c0s0` | `c16s41_c4s3_c0s0` |
...
| `ssh2.pcapng` | per-packet | JA4SSH | 1 | `ssh2.pcapng/670/JA4SSH.1` | the vector holds a value the library does not produce | `c36s36_c76s124_c74s5` | (none) |
...
| `ssh2.pcapng` | per-stream | JA4SSH | 2 | `ssh2.pcapng/14/JA4SSH.1` | the two values differ | `c36s36_c76s124_c74s5` | `c16s41_c4s3_c124s7` |
| `ssh2.pcapng` | per-stream | JA4SSH | 2 | `ssh2.pcapng/14/JA4SSH.2` | the vector holds a value the library does not produce | `c36s36_c0s0_c2s0` | (none) |
...
| `sshv1.pcap` | per-packet | JA4SSH | 4 | `sshv1.pcap/72/JA4SSH.1` | the vector holds a value the library does not produce | `c20s12_c18s21_c10s1` | (none) |
...
| `v6.pcap` | per-packet | JA4SSH | 4 | `v6.pcap/72/JA4SSH.1` | the vector holds a value the library does not produce | `c20s12_c18s21_c10s1` | (none) |
...
| `gre-sample.pcap` | JA4SSH | per-packet | deviation | 0 | 2 | — |
...
| `ssh-r.pcap` | JA4SSH | per-packet and per-stream | deviation | 0 | 19 | — |
...
| `ssh-scp-1050.pcap` | JA4SSH | per-packet and per-stream | deviation | 0 | 8 | — |
...
| `ssh.pcapng` | JA4SSH | per-packet and per-stream | deviation | 0 | 2 | — |
...
| `ssh2.pcapng` | JA4SSH | per-packet and per-stream | deviation | 0 | 3 | — |
