...
|---|---|---|---|---|---|
| per-stream | 1103 | 62 | 276 | 132 | 34 |
| per-packet | 555 | 523 | 143 | 60 | 6 |
...
The run reports 1004 deviations in 86 groups. One group is one capture, one method and one vector set.
...
The run reports 232 uncovered values in 61 groups, and the register accepts 40 of them. One group is one capture, one method and one vector set.
