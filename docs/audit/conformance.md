...
The run reports 858 deviations in 79 groups. One group is one capture, one method and one vector set.
...
The run reports 203 uncovered values in 59 groups, and the register accepts 20 of them. One group is one capture, one method and one vector set.
