...
| delegated ruling | noun | One ruling the project manager makes under a delegation that the maintainer granted. The narrow delegation of 2026-08-12 reaches a schema violation, under five conditions. The widened delegation of 2026-08-13 reaches the four open questions #289, #300, #346 and #369, under three decisive cases. A question that fails the five narrow conditions can still meet a decisive case. A genuine reference split fails both delegations, and it belongs to the maintainer. A delegated ruling stays provisional until the maintainer confirms it, and a later reader reads an unconfirmed one as unconfirmed. `.claude/rules/rulings.md` states each delegation. | automatic ruling, agent ruling, provisional decision |
...
2026-08-12. **Not one of those five carries the label today**, and #53 is closed. **One issue
carries the label today, and it is #364.** The command
`gh issue list --label status:needs-feedback --state all --limit 300` measured that on
2026-08-13. This sentence named six issues before that measurement: #126, #129, #289 and
#300 are closed, #298 carries `status:ready`, and #346 carries `status:batched`. #279
reconciles the rows and the count. **#50 removed its own row alone, because its question is closed.** **#61 removed its
