...
### R9 — Three rulings the port never made (question 1 is closed)
...
`technical_details/JA4.md:92` covers three inputs in one sentence, and this is the verbatim
text:
