...
| maintainer | noun | The one person who makes a ruling for this project. `.claude/rules/rulings.md` and `.claude/rules/parity.md` each name the maintainer, and nobody else. | owner, lead, author |
| project manager | noun | The session the maintainer delegates a set of issues to. It makes a delegated ruling, and it makes no other ruling. | PM, orchestrator, coordinator |
