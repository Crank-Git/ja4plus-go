...
| delegation | noun | One grant of ruling authority that the maintainer gives to the project manager. `.claude/rules/rulings.md` `## What a delegated session may rule` states the two this project holds, and the word names no handover of a task. | task handoff, mandate |
