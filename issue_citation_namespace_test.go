...
// The #556 hotfix re-measured the mark on 2026-08-14 and it read 560. That hotfix cites
// `#556` in a code comment and in a test, and 556 sits above the inherited mark of 543. A
...
const issueCitationHighWaterMark = 560
