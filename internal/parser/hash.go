...
//
// JA4H part b and the three JA4X parts are the callers outside this file, and
// `TruncatedHash` above calls it for a non-empty input. R18 of `docs/specs/foxio/JA4H.md`
// states `Truncated SHA256 hash of Headers, in the order they appear`, and it names no
// sentinel. R27 of the same page confines the sentinel to part c and to part d. The Rust
// reference and the Zeek package write the sentinel in part b, and a rank 1 image rule
// outranks an implementation. The maintainer ruled the split on 2026-08-14.
//
// Issue #527 is the reversal path of the JA4H half, and the port half is
// `Crank-Git/ja4plus#612`. Issue #582 is the reversal path of the JA4X half, and the port
// half is `Crank-Git/ja4plus#619`. R12 of `docs/specs/foxio/JA4X.md` holds the JA4X split.
